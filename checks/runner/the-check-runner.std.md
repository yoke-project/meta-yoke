...
| **Planning item** | yoke-project/meta-yoke#11 |

## meta-yoke:the-check-runner.01 — a check whose name holds a digit is run
...
## meta-yoke:the-check-runner.02 — a marker whose check cannot be found is reported as failing
