...
| **Planning item** | yoke-project/meta-yoke#1 |

## meta-yoke:verbs-and-licence.01 — every verb is defined, and none is silent
...
## meta-yoke:verbs-and-licence.02 — nothing resolves a path outside the repository
...
## meta-yoke:verbs-and-licence.03 — the repository builds in the container it defines itself
...
## meta-yoke:verbs-and-licence.04 — the licence is the one this repository's role assigns
...
| **Expected** | the licence is **MIT**, the one rule 4 assigns to a layer published into an ecosystem whose convention it is (398), and it names the copyright holder; no second licence file stands beside it — the check tests the assignment and not a file's existence |

## meta-yoke:verbs-and-licence.05 — `develop` fails on a runner older than the floor
